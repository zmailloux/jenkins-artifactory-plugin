...
public class PromotionUtils {
    ...
    public static boolean promoteAndCheckResponse(Promotion promotion, ArtifactoryBuildInfoClient client, TaskListener listener,
                                                  String buildName, String buildNumber, Boolean deployBuild, String deployURL) throws IOException {
        // If failFast is true, perform dry run first
        listener.getLogger().println(promotion.getProperties());
        ...
        if (deployBuild) {
            ...
            listener.getLogger().println("No build triggered.");
        }
