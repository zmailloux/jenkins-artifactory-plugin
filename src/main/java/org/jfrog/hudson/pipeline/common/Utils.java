...
public class Utils {
    ...
    public static PromotionConfig createPromotionConfig(Map<String, Object> promotionParams, boolean isTargetRepositoryMandatory) {
        ...
        List<String> allowedParams = Arrays.asList(ArtifactoryServer.BUILD_NAME, ArtifactoryServer.BUILD_NUMBER, targetRepository, "sourceRepo", "status", "comment", "deployBuild", "deployURL", "includeDependencies", "copy", "failFast");
    ...
    public static org.jfrog.hudson.release.promotion.PromotionConfig convertPromotionConfig(PromotionConfig pipelinePromotionConfig) {
        ...
        promotionConfig.setDeployBuild(pipelinePromotionConfig.isDeployBuild());
        promotionConfig.setDeployURL(pipelinePromotionConfig.getDeployURL());
